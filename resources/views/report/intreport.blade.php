                        ...
                        <table id="datatable" class="table table-bordered table-striped" style="overflow-x: scroll;">
                            ...
                            @for($i=0;$i<count($data);$i++)
                                <tr>
                                    ...
                                    @if($i==0)
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR SYNC CUSTOMER","min"])}}" target="_blank">{{$datamin24[$i]->esc}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR SYNC CUSTOMER","max"])}}" target="_blank">{{$datamax24[$i]->esc}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR TSQ","min"])}}" target="_blank">{{$datamin24[$i]->et}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR TSQ","max"])}}" target="_blank">{{$datamax24[$i]->et}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR DELIVER","min"])}}" target="_blank">{{$datamin24[$i]->ed}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR DELIVER","max"])}}" target="_blank">{{$datamax24[$i]->ed}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR FULFILL BILLING START","min"])}}" target="_blank">{{$datamin24[$i]->efbs}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR FULFILL BILLING START","max"])}}" target="_blank">{{$datamax24[$i]->efbs}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"NEED DELIVER","min"])}}" target="_blank">{{$datamin24[$i]->nd}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"NEED DELIVER","max"])}}" target="_blank">{{$datamax24[$i]->nd}}</a></td>
                                        ...
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"CANCEL FROM OSS","min"])}}" target="_blank">{{$datamin24[$i]->cfo}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"CANCEL FROM OSS","max"])}}" target="_blank">{{$datamax24[$i]->cfo}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR AREA","min"])}}" target="_blank">{{$datamin24[$i]->ea}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"ERROR AREA","max"])}}" target="_blank">{{$datamax24[$i]->ea}}</a></td>

                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"TSQ","min"])}}" target="_blank">{{$datamin24[$i]->tsq}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"TSQ","max"])}}" target="_blank">{{$datamax24[$i]->tsq}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"DELIVER","min"])}}" target="_blank">{{$datamin24[$i]->del}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"DELIVER","max"])}}" target="_blank">{{$datamax24[$i]->del}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"PENDING BASO","min"])}}" target="_blank">{{$datamin24[$i]->pb}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"PENDING BASO","max"])}}" target="_blank">{{$datamax24[$i]->pb}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"PENDING BILLING APPROVAL","min"])}}" target="_blank">{{$datamin24[$i]->pba}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"PENDING BILLING APPROVAL","max"])}}" target="_blank">{{$datamax24[$i]->pba}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"COMPLETE","min"])}}" target="_blank">{{$datamin24[$i]->com}}</a></td>
                                        <td class="primary" align="right"><a href="{{route('ora.getorderdetail',[$data[$i]->li_status,$data[$i]->milestone,"COMPLETE","max"])}}" target="_blank">{{$datamax24[$i]->com}}</a></td>
                                    @else
